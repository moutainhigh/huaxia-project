...
import com.huaxia.opas.service.rule.LoansRuleService;

public class LoansRuleServiceImpl implements LoansRuleService{

	private static final Logger log = Logger.getLogger(LoansRuleServiceImpl.class);
	...
	public Map<String, Object> invokeRule(String appId) throws Exception {
		...
		request.setProjectName("project1600");
		...
		request.setBusinessNo("多头借贷业务查询平台");
		...
		try {
			...
			if (outParams != null) {
				...
				outPut.put("loans_rule_out", sroout);
				log.error("规则输出信息:" + sroout.toString());
			}
		} catch (Exception e) {
