...
public class Opaspbocoverdueandfellback implements Serializable{
    private String insideAppNo;

    private String badDebtNum;

    private String badDebtBalance;

    private String assDisNum;

    private String assDisBalance;

    private String guaCompenNum;

    private String guaCompenBalance;

    private String loanOverdueAcctNum;

    private String loanOverdueMonthNum;

    private String loanOverdueOverDueAmt;

    private String loanOverdueLongestOverDue;

    private String debitCardOverDueAcctNum;

    private String debitCardOverDueMonthNum;

    private String debitCoDueOverDueAmt;

    private String debitCoDueLongestOverDue;

    private String debC60overdAcctNum;

    private String debC60overdMonthNum;

    private String debC60overdOverDueAmt;

    private String debC60overdLongestOverDue;
