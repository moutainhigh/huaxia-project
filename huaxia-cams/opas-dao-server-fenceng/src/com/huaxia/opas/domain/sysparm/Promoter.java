...
public class Promoter implements Serializable {
	private static final long serialVersionUID = -3624431842940950571L;
	//主键Id
	...
	public Promoter(String autoId, String promoterName, String promoterNo, String certifiType, String certifiNo,
			String mobileNo, String infoChannel, String fraudType, String memo, Date invalidTime, Date createTime,
			String operator, Date operatTime, String currStatus) {
		super();
		this.autoId = autoId;
