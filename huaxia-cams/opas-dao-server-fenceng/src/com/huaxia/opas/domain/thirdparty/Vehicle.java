...
public class Vehicle {
    ...
    private String carUseProp;//使用性质
    ...
    public String getSendOrgNo() {
        return sendOrgNo;
    }

    public void setSendOrgNo(String sendOrgNo) {
        this.sendOrgNo = sendOrgNo == null ? null : sendOrgNo.trim();
    }
    ...
    public String getCarUseProp() {
        return carUseProp;
    }

    public void setCarUseProp(String carUseProp) {
        this.carUseProp = carUseProp == null ? null : carUseProp.trim();
    }
