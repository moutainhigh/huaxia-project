...
public class BizApproval implements Serializable {
	private static final long serialVersionUID = 7269049453507525714L;
	...
	private String laojianNum;
	
	private BigDecimal spRefUnPlgeDti;
	
	private BigDecimal spRefCpDti;
	
	private BigDecimal spRefMue;
	
	private String spDebtAppAuth;
	
	private String initSaveFlag;
	...
	public String getInitSaveFlag() {
		return initSaveFlag;
	}

	public void setInitSaveFlag(String initSaveFlag) {
		this.initSaveFlag = initSaveFlag;
	}

	public BigDecimal getSpRefUnPlgeDti() {
		return spRefUnPlgeDti;
	}

	public void setSpRefUnPlgeDti(BigDecimal spRefUnPlgeDti) {
		this.spRefUnPlgeDti = spRefUnPlgeDti;
	}

	public BigDecimal getSpRefCpDti() {
		return spRefCpDti;
	}

	public void setSpRefCpDti(BigDecimal spRefCpDti) {
		this.spRefCpDti = spRefCpDti;
	}

	public BigDecimal getSpRefMue() {
		return spRefMue;
	}

	public void setSpRefMue(BigDecimal spRefMue) {
		this.spRefMue = spRefMue;
	}

	public String getSpDebtAppAuth() {
		return spDebtAppAuth;
	}

	public void setSpDebtAppAuth(String spDebtAppAuth) {
		this.spDebtAppAuth = spDebtAppAuth;
	}

	public String getLaojianNum() {
		return laojianNum;
	}

	public void setLaojianNum(String laojianNum) {
		this.laojianNum = laojianNum;
	}
