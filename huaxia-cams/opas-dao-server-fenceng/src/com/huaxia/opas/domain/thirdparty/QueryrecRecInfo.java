...
public class QueryrecRecInfo {
    private String insideAppNo;

    private String qryApplyWay;
    ...
    public String getQryApplyWay() {
        return qryApplyWay;
    }

    public void setQryApplyWay(String qryApplyWay) {
        this.qryApplyWay = qryApplyWay == null ? null : qryApplyWay.trim();
    }
