...
public class BranchLevelParam implements Serializable {
	...
	private static final long serialVersionUID = -3922174115120262399L;
	...
	public void setBranchParentId(String branchParentId) {
		this.branchParentId = (branchParentId == null ? null : branchParentId.trim());
	}
	...
	public void setBranchAppOrgCode(String branchAppOrgCode) {
		this.branchAppOrgCode = (branchAppOrgCode == null ? null : branchAppOrgCode.trim());
	}
