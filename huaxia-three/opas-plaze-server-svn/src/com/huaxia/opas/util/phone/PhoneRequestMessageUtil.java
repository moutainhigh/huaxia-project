...
public class PhoneRequestMessageUtil {

	public static String assemblingParameters(String trnId, String TrnCode, String CertType, String CertNo, String name,
	...
	public static void main(String[] args) {
		String testPa = assemblingParameters("1111", "T001110", "10", "622926198501293785", "张三", "13354260593", "1");
