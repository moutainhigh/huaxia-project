 ...
 *
 */
public class WST000200TaskWorker implements Runnable {

	private final static Logger logger = LoggerFactory.getLogger(WST000200TaskWorker.class);
	...
	private final String taskType = "000200";
	...
	private void getResult(String str, String APP_ID) {
		...
		if (message != null && !"".equals(message) && "000000".equals(code)) {
			...
			// 删除 原先存在的公安照片
			CommonUtil.rmHardDiskFile(photoSavePath + File.separator, APP_ID + photoSubfix, APP_ID, "简项公安照片");
			try {
