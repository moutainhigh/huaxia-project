...
<body>
	<form id="frmList" enctype="multipart/form-data" method="post"
		...
		<table>
			<caption>同盾多头借贷批量导入</caption>
			<tr>
				<td align="left" colspan="2"><a href="javascript:files.click();"
...
<script type="text/javascript">
	...
	function refresh() {
		window.location.href = "${basePath}/tongdun/mulbor/batch/index.do";
	}
</script>
</html>