...
<script type="text/javascript">
	...
	function page(p, s, e) {
		...
		$('#pageSize').val(s);
		var f = $('#frmList');
		f.action = "${basePath}/tongdun/mulbor/batch/pagelist/batch.do";
		f.submit();
	}

	function detail(bid) {
		window.open(
				"${basePath}/tongdun/mulbor/batch/pagelist/batchfile.do?batchId="
						+ bid, '_blank');
	}
</script>
</html>