		...
		<section class="form-layout">
			<table border="1">
				...
				<tr>
					...
					<td><input type="text" id="user_name" name="account"></td>
				</tr>
				<tr>
					<td><label>用户工号：</label></td>
					<td><input type="text" id="user_staff_id" name="staffId"></td>
				</tr>
				<tr>
					<td><label>用户姓名：</label></td>
					<td><input type="text" id="user_staff_name" name="staffName"></td>
				</tr>
				<tr>
					<td><label>证件类型：</label></td>
					<td><select id="user_cert_type" name="certType" groupCode="CERT_TYPE" style="width:146px;"></select></td>
				</tr>
				<tr>
					<td><label>证件号码：</label></td>
					<td><input type="text" id="user_cert_no" name="certNo"></td>
				</tr>
				<tr>
					<td><label>部门：</label></td>
					<td><input type="text" id="user_department" name="department"></td>
				</tr>
				<tr>
					<td><label>团队：</label></td>
					<td><input type="hidden" id="user_team_id" name="team"><input type="text" id="user_team_name" readonly="readonly">&nbsp;<input type="button" id="btnShowTeam" value="团队选择" /></td>
				</tr>
				<tr>
					<td><label>岗位：</label></td>
					<td><input type="text" id="user_post" name="post"></td>
				</tr>
				<tr>
					<td><label>手机号码：</label></td>
					<td><input type="text" id="user_mobile" name="mobile"></td>
				</tr>
				<tr>
					<td><label>终端地址：</label></td>
					<td><input type="text" id="user_ip" name="ip"></td>
				</tr>
				<tr>
					<td><label>用户状态：</label></td>
					<td><select id="user_status" name="status" groupCode="ACCOUNT_STATUS" style="width:146px;"></select></td>
				</tr>
				<tr>
					<td><label>是否有人行查询权限：</label></td>
					<td><input type="radio" name="pbocAuth" value="1" />是&nbsp;<input type="radio" name="pbocAuth" checked="checked" value="0" />否</label></td>
				</tr>
				<tr>
					<td><label>人行查询权限：</label></td>
				...
				<tr>
					...
					<td><input type="text" id="user_pboc_auth_query_time" name="pbocAuthQueryTime" /></td>
				</tr>
				<tr>
					<td><label>人行单日最大查询条数：</label></td>
					<td><input type="text" id="user_pboc_query_max_count" name="pbocDayQueryMaxCount" value="300"></td>
				</tr>
				<tr>
					<td><label>人行单日最大查找条数：</label></td>
					<td><input type="text" id="user_pboc_search_max_count" name="pbocDaySearchMaxCount" value="300"></td>
				</tr>
			</table>
		</section>
...
$(function() {
	...
	$('#btnSave').on('click', function() {
		...
		$.ajax({
			url : "${basePath}/system/user/save.do",
			type : 'post',
