...
<body>
	<form id="frmList" enctype="multipart/form-data" method="post"
		...
		<table style="border-collapse: separate; border-spacing: 5px;">
			...
			<tr>
				<td colspan="2"><input style="text-align: center; display: inline-block; width: 93px; height: 30px" type="button" value="提交查询" onclick="onSubmit()" /></td>
			</tr>
		</table>
	</form>
	<div id="modelLoading"
...
<script type="text/javascript">
	...
	function refresh() {
		window.location.href = "${basePath}/nciic/police/batch/query/index.do";
	}
</script>
</html>